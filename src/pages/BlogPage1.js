...
import { faPen, faClock, faSection, faBars, faChevronLeft, faChevronRight, faTag } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="BlogPage_Container">
        ...
        <div className="BlogPage_TitleSection">
          ...
          <div className="blog_tags">
            <span className="sub-body"><FontAwesomeIcon className='article_icon' icon={faTag} />&nbsp;</span>
            <span className="sub-body"><Link className='blog_links' to='/'>computer vision,&nbsp;</Link></span>
            <span className="sub-body"><Link className='blog_links' to='/'>deep learning,&nbsp;</Link></span>
            <span className="sub-body"><Link className='blog_links' to='/'>face detection,&nbsp;</Link></span>
            <span className="sub-body"><Link className='blog_links' to='/'>python</Link></span>
          </div>
        ...
        <div className="BlogPage_ContentSection">
          {/* Summary Section */}
          <span className="section_title sectionIcon" id='summary'><FontAwesomeIcon icon={faSection} />  Summary</span>
          ...
          {/* First Section */}
          <span className="section_title sectionIcon" id='first'><FontAwesomeIcon icon={faSection} />  Prerequisites</span>
          ...
          <span className="subSection_title sectionIcon" id='first_first'><FontAwesomeIcon className='subSection' icon={faBars} />  Installing MediaPipe Model Maker</span>
          ...
          <span className="subSection_title sectionIcon" id='first_second'><FontAwesomeIcon className='subSection' icon={faBars} />  Getting the data</span>
          ...
          <span className="subSection_title sectionIcon" id='first_third'><FontAwesomeIcon className='subSection' icon={faBars} />  Data preparation</span>
          ...
          {/* References */}
          <span className="section_title reference_section_title sectionIcon" id='references'><FontAwesomeIcon icon={faSection} />  References</span>
