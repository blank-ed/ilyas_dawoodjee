...
const BlogPage5Data = [
    // Title Section
    {
        type: 'div', className: 'BlogPage_TitleSection', data: [
            { type: 'span', className: 'mainTitle', data: `${BlogData[4].article_title}` },
            {
            ...
            },
            {
                type: 'div', className: 'blog_tags', data: [
                    ...
                    { type: 'span', className: 'sub-body', data: [{ type: 'Link', to: `${BlogData[4].article_tags[0].tag_link}`, className: 'blog_links_inverse', data: `${BlogData[4].article_tags[0].tag_name}, ` }] },
                    { type: 'span', className: 'sub-body', data: [{ type: 'Link', to: `${BlogData[4].article_tags[1].tag_link}`, className: 'blog_links_inverse', data: `${BlogData[4].article_tags[1].tag_name}, ` }] },
                    { type: 'span', className: 'sub-body', data: [{ type: 'Link', to: `${BlogData[4].article_tags[2].tag_link}`, className: 'blog_links_inverse', data: `${BlogData[4].article_tags[2].tag_name}, ` }] },
                    { type: 'span', className: 'sub-body', data: [{ type: 'Link', to: `${BlogData[4].article_tags[3].tag_link}`, className: 'blog_links_inverse', data: `${BlogData[4].article_tags[3].tag_name}` }] }
                ]
            },
            {
        ...
        type: 'div', className: 'BlogPage_ContentSection', data: [
            ...
            // Footer
            {
                type: 'span', className: 'blog_footer', data: [
                    { type: 'span', className: 'body footer_left', data: [{ type: "Link", className: 'blog_links_inverse', to: `${BlogData[3].article_link}`, icon: faChevronLeft, position: 'left', data: `${BlogData[3].article_title}` }] },
                    // { type: 'span', className: 'body footer_right', data: [{ type: "Link", className: 'blog_links_inverse', to: `${BlogData[5].article_link}`, icon: faChevronRight, position: 'right', data: 'Right Link Right Link Right Link Right Link' }] }
                ]
            }
        ]
    }
...
const wordCount = extractAndCountWords(BlogPage5Data);;
const timeTaken = Math.ceil(wordCount / 200);

BlogPage5Data[0].data[1].data.push(
    { type: 'span', className: 'date sub-body', icon: faCalendarDays, data: `${BlogData[4].published_date}` },
    ...
    { type: 'span', className: 'folder sub-body', icon: faFolderOpen, data: [{ type: 'Link', to: `${BlogData[4].published_folder}`, className: 'blog_links', data: `${BlogData[4].folder_name}` }] }
);

export default BlogPage5Data;