...
const BlogPage2Data = [
    // Title Section
    {
        type: 'div', className: 'BlogPage_TitleSection', data: [
            { type: 'span', className: 'mainTitle', data: `${BlogData[1].article_title}` },
            {
            ...
            },
            {
                type: 'div', className: 'blog_tags', data: [
                    ...
                    { type: 'span', className: 'sub-body', data: [{ type: 'Link', to: `${BlogData[1].article_tags[0].tag_link}`, className: 'blog_links_inverse', data: `${BlogData[1].article_tags[0].tag_name}, ` }] },
                    { type: 'span', className: 'sub-body', data: [{ type: 'Link', to: `${BlogData[1].article_tags[1].tag_link}`, className: 'blog_links_inverse', data: `${BlogData[1].article_tags[1].tag_name}, ` }] },
                    { type: 'span', className: 'sub-body', data: [{ type: 'Link', to: `${BlogData[1].article_tags[2].tag_link}`, className: 'blog_links_inverse', data: `${BlogData[1].article_tags[2].tag_name}, ` }] },
                    { type: 'span', className: 'sub-body', data: [{ type: 'Link', to: `${BlogData[1].article_tags[3].tag_link}`, className: 'blog_links_inverse', data: `${BlogData[1].article_tags[3].tag_name}` }] }
                ]
            },
            {
...
BlogPage2Data[0].data[1].data.push(
    { type: 'span', className: 'date sub-body', icon: faCalendarDays, data: `${BlogData[1].published_date}` },
    ...
    { type: 'span', className: 'folder sub-body', icon: faFolderOpen, data: [{ type: 'Link', to: `${BlogData[1].published_folder}`, className: 'blog_links', data: `${BlogData[1].folder_name}` }] }
);
