...
const BlogData = [
    {
        ...
        article_link: "/",
        article_tags: [
            { tag_name: "x", tag_link: '/projects' },
            { tag_name: "xx", tag_link: '/projects' },
            { tag_name: "xxx", tag_link: '/projects' },
            { tag_name: "xxxx", tag_link: '/projects' },
            { tag_name: "xxxxx", tag_link: '/projects' }
        ],
    },
    // {
    //     image: BlogPage1Image,
